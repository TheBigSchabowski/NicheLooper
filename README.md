...
> Hinweis: Aktuell ist noch **keine DMG veröffentlicht**. Sobald eine Version
> als GitHub-Release hochgeladen wird, erscheint sie dort zum Download. Bis
> dahin kann die App nur aus dem Quellcode gebaut werden (siehe unten).
